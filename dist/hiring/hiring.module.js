...
exports.HiringModule = HiringModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [jobs_service_1.JobsService, applications_service_1.ApplicationsService],
        controllers: [jobs_controller_1.JobsController, applications_controller_1.ApplicationsController],
    })
], HiringModule);
